...
import fundoImagem from "@assets/fundo-imagem.jpeg";
  ...
  return (
    <Layout>
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" />
